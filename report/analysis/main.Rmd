...
params:
  child: !r c("targets.Rmd", "samples.Rmd", "failed.Rmd","reads.Rmd", "coverage.samples.Rmd", "coverage.intervals.Rmd", "variants.Rmd", "signatures.Rmd", "tmb.Rmd", "hapmap.pool.Rmd")
  input_dir: input
